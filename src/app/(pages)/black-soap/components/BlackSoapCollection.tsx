...
const BlackSoapCollection: React.FC<CollectionSectionProps> = ({ collectionRef }) => {
  const router = useRouter();

  return (
    <div className="p-5" ref={collectionRef as React.RefObject<HTMLDivElement>}>
      <div className="flex flex-col justify-center items-center mb-10">
        <h2 className="mb-1 text-primary font-bold text-center text-lg">Our Black Soap</h2>
      ...
      <div className="flex flex-col items-center gap-y-10">
        ...
        <button
          onClick={() => router.push('/product/black-soap')}
...
export default BlackSoapCollection;
